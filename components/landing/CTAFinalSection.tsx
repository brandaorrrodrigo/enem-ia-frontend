    ...
    <section className="py-32 px-6 relative overflow-hidden z-10">
      ...
      <div className="container max-w-5xl mx-auto relative z-20">
        ...
        >
          ...
          >
            <div className="inline-flex items-center gap-4 text-8xl sm:text-9xl lg:text-[10rem]">
              <span>🎯</span>
              <span>📚</span>
              <span>🏆</span>
            </div>
              ...
              <div className="relative z-10 px-5 sm:px-6 lg:px-8 py-6 sm:py-7 lg:py-8">
                <div className="space-y-5">
                  {[
                    ...
                    >
                      <span className="text-3xl sm:text-4xl lg:text-5xl text-[var(--accent-yellow)] flex-shrink-0">{item.icon}</span>
          ...
          >
            <Link
              href="/cadastro"
              className="inline-block btn-yellow px-12 sm:px-16 lg:px-24 py-5 sm:py-6 lg:py-8 min-h-[48px] text-lg sm:text-xl lg:text-2xl font-bold rounded-full shadow-2xl transform transition-all hover:scale-110 hover:shadow-[0_15px_50px_rgba(255,215,0,0.6)] whitespace-nowrap"
            >
          ...
          >
            <div className="flex items-center gap-3 sm:gap-4">
              <span className="text-[var(--accent-green)] text-4xl sm:text-5xl lg:text-6xl">✓</span>
      ...
      <div className="absolute top-20 left-10 text-8xl sm:text-9xl opacity-20">✨</div>
      <div className="absolute top-40 right-20 text-8xl sm:text-9xl opacity-20">🌟</div>
      <div className="absolute bottom-20 left-1/4 text-8xl sm:text-9xl opacity-20">💫</div>
      <div className="absolute bottom-32 right-1/3 text-8xl sm:text-9xl opacity-20">⭐</div>
    </section>
  );
}

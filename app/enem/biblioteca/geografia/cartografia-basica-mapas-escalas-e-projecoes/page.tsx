...
export default function CartografiaBasicaMapasEscalasEProjecoesPage() {
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-12">
          <h1 className="text-4xl sm:text-5xl font-bold mb-4 bg-gradient-to-r from-white to-white/80 bg-clip-text text-transparent">
            Cartografia básica: mapas, escalas e projeções
          </h1>
        ...
        {showQuiz && (
          <section className="mb-12">
            <MicroQuiz
              moduloSlug="geografia_cartografia-basica-mapas-escalas-e-projecoes"
              questoes={questoes}
            />
          </section>
        )}

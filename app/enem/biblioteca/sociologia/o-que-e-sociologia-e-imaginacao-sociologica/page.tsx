...
export default function OQueESociologiaEImaginacaoSociologicaPage() {
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-12">
          <h1 className="text-4xl sm:text-5xl font-bold mb-4 bg-gradient-to-r from-white to-white/80 bg-clip-text text-transparent">
            O que é Sociologia e “imaginação sociológica”
          </h1>
          ...
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
            <div className="flex items-center gap-3 mb-6">
              <div className="p-2 bg-#7c3aed/20 rounded-lg">
                <BookOpen className="w-6 h-6 text-#7c3aed" style={{ color: '#7c3aed' }} />
              </div>
                    ...
                    <div className="space-y-2">
                      {q.alternativas.map((alt, altIdx) => (
                        <div key={altIdx} className="flex items-start gap-3 p-3 rounded-lg hover:bg-white/5 transition-colors">
                          <span className="font-medium text-#7c3aed" style={{ color: '#7c3aed' }}>
        ...
        {showQuiz && (
          <section className="mb-12">
            <MicroQuiz
              moduloSlug="sociologia_o-que-e-sociologia-e-imaginacao-sociologica"
              questoes={questoes}
            />
          </section>
        )}

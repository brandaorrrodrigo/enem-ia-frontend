          ...
          {planos.map((plano, index) => {
            ...
            return (
              ...
              >
                {/* Badge "Mais Popular" */}
                {plano.popular && (
                  <div className="absolute -top-16 left-1/2 transform -translate-x-1/2 bg-[var(--accent-yellow)] text-[#1a3328] px-8 py-3 rounded-full font-['Patrick_Hand'] font-bold shadow-lg whitespace-nowrap z-20" style={{ fontSize: '32px' }}>
                    MAIS POPULAR
                  </div>
                )}

...
export default function OQueEFilosofiaEOPensamentoCriticoPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-cyan-900 to-cyan-700 text-white">
      {/* Barra de progresso */}
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-12">
          <h1 className="text-4xl sm:text-5xl font-bold mb-4 bg-gradient-to-r from-white to-white/80 bg-clip-text text-transparent">
            O que é Filosofia e o pensamento crítico
          </h1>
          ...
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
            <div className="flex items-center gap-3 mb-6">
              <div className="p-2 bg-#0891b2/20 rounded-lg">
                <BookOpen className="w-6 h-6 text-#0891b2" style={{ color: '#0891b2' }} />
              </div>
                    ...
                    <div className="space-y-2">
                      {q.alternativas.map((alt, altIdx) => (
                        <div key={altIdx} className="flex items-start gap-3 p-3 rounded-lg hover:bg-white/5 transition-colors">
                          <span className="font-medium text-#0891b2" style={{ color: '#0891b2' }}>
        ...
        {showQuiz && (
          <section className="mb-12">
            <MicroQuiz
              moduloSlug="filosofia_o-que-e-filosofia-e-o-pensamento-critico"
              questoes={questoes}
            />
          </section>
        )}

...
export default function ConnectivesPage() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (percent > progresso) {
        ...
        localStorage.setItem('biblioteca_ingles_connectives', Math.floor(percent).toString());
      }
    };

    const savedProgress = localStorage.getItem('biblioteca_ingles_connectives');
    if (savedProgress) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0d2818] to-[#1b3d29] text-white font-['Poppins'] relative overflow-hidden">
      ...
      >
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-5xl font-bold font-['Patrick_Hand']">Vocabulary - Connectives</h1>
              <p className="text-xl text-white/80 mt-2">Conectivos e linking words</p>
            </div>
          </div>
      ...
      <div className="max-w-4xl mx-auto px-8 py-12">
        ...
        >
          ...
          <p className="text-lg text-white/90 leading-relaxed">Conectivos (linking words) ligam ideias no texto. Essenciais para compreensão de textos e para identificar relações lógicas entre frases e parágrafos.</p>
        </motion.div>
        ...
        >
          ...
          <div className="space-y-4">
            ...
            >
              <h3 className="text-xl font-bold mb-2">Adição</h3>
              <p className="text-white/80">And, also, furthermore, moreover, in addition, besides. Ex: "I like tea. Moreover, I drink it every day."</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-white/80">But, however, although, though, despite, in spite of, yet, nevertheless. Ex: "I studied hard. However, I failed."</p>
            </motion.div>
            ...
            >
              <h3 className="text-xl font-bold mb-2">Causa e Efeito</h3>
              <p className="text-white/80">Because, since, as, so, therefore, thus, consequently, as a result. Ex: "It rained, so we stayed home."</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-white/80">In conclusion, to sum up, finally, in short, therefore. Ex: "In conclusion, we need to act now."</p>
            </motion.div>
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <div className="mb-3">
                ...
                <p className="text-white/70 mt-1">___ it was raining, we went out.</p>
              </div>
              <div>
                <strong className="text-white/90">Solução:</strong>
                <p className="text-white/70 mt-1">Although it was raining, we went out. (apesar de)</p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="mb-3">
                <strong className="text-white/90">Problema:</strong>
                <p className="text-white/70 mt-1">I was tired ___ I had studied all night.</p>
              </div>
              <div>
                <strong className="text-white/90">Solução:</strong>
                <p className="text-white/70 mt-1">I was tired because I had studied all night.</p>
              </div>
            </motion.div>
        ...
        >
          ...
          <div className="grid gap-4">
            ...
            >
              ...
              <p className="text-white/90">Identifique a relação lógica entre frases</p>
            </motion.div>
            ...
            >
              <span className="text-2xl">✓</span>
              <p className="text-white/90">However, therefore = início de frase</p>
            </motion.div>
            ...
            >
              <span className="text-2xl">✓</span>
              <p className="text-white/90">But, so = meio de frase</p>
            </motion.div>
            ...
            >
              <span className="text-2xl">✓</span>
              <p className="text-white/90">Although, despite = contraste (mas tem diferença de estrutura)</p>
            </motion.div>
        ...
        >
          ...
          <div className="grid gap-4">
            ...
            >
              <span className="text-2xl">✗</span>
              <p className="text-white/90">Usar "but" e "although" juntos ❌</p>
            </motion.div>
            ...
            >
              <span className="text-2xl">✗</span>
              <p className="text-white/90">Confundir "so" (então) com "such" (tal)</p>
            </motion.div>
            ...
            >
              <span className="text-2xl">✗</span>
              <p className="text-white/90">Estrutura errada após "despite" (despite + substantivo/ing)</p>
            </motion.div>

    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0d2818] to-[#1b3d29] text-white font-['Poppins'] relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-8 py-12">
        ...
        >
          ...
          <p className="text-lg text-white/90 leading-relaxed">Os tempos verbais no passado descrevem ações concluídas ou que estavam em progresso em momentos anteriores. São cruciais para narração e descrição de eventos.</p>
        </motion.div>
        ...
        >
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <p className="text-white/80">Ações concluídas no passado. Forma: V-ed (regulares) ou forma irregular. Exemplo: "I worked yesterday."</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-white/80">Ação em progresso em momento específico do passado. Forma: was/were + V-ing. Exemplo: "I was studying when you called."</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-white/80">Ação anterior a outra no passado. Forma: had + past participle. Exemplo: "I had finished before she arrived."</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-white/80">Ação contínua antes de outra no passado. Forma: had been + V-ing. Exemplo: "I had been waiting for an hour."</p>
            </motion.div>
        ...
        >
          ...
          <div className="space-y-6">
            ...
            <motion.div
              ...
              transition={{ duration: 0.5, delay: 0 }}
            >
              <h3 className="text-xl font-bold mb-3">Narração</h3>
              <div className="mb-3">
              ...
              <div>
                ...
                <p className="text-white/70 mt-1">I was watching TV when the phone rang. (continuous + simple para interrupção)</p>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              transition={{ duration: 0.5, delay: 0.1 }}
            >
              <h3 className="text-xl font-bold mb-3">Sequência no passado</h3>
              <div className="mb-3">
                <strong className="text-white/90">Problema:</strong>
              ...
              <div>
                <strong className="text-white/90">Solução:</strong>
                <p className="text-white/70 mt-1">When I arrived, they had already left. (past perfect para ação anterior)</p>
              </div>
            </motion.div>
        ...
        >
          ...
          <div className="grid gap-4">
            ...
            >
              ...
              <p className="text-white/90">Past Simple para ações específicas concluídas</p>
            </motion.div>
            ...
            >
              <span className="text-2xl">✓</span>
              <p className="text-white/90">Past Continuous para ação em progresso no passado</p>
            </motion.div>
        ...
        >
          ...
          <div className="grid gap-4">
            ...
            >
              <span className="text-2xl">✗</span>
              <p className="text-white/90">Usar "did" com verbo no passado: "Did you went?" ❌</p>
            </motion.div>

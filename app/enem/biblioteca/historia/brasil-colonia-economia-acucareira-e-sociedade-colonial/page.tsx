...
export default function BrasilColoniaEconomiaAcucareiraESociedadeColonialPage() {
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-12">
          <h1 className="text-4xl sm:text-5xl font-bold mb-4 bg-gradient-to-r from-white to-white/80 bg-clip-text text-transparent">
            Brasil Colônia: economia açucareira e sociedade colonial
          </h1>
        ...
        {showQuiz && (
          <section className="mb-12">
            <MicroQuiz
              moduloSlug="historia_brasil-colonia-economia-acucareira-e-sociedade-colonial"
              questoes={questoes}
            />
          </section>
        )}

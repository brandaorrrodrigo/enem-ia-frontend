  ...
  return (
    <section id="diferenciais" className="py-28 px-6 relative z-10">
      <div className="container max-w-6xl mx-auto relative z-20">
        ...
        >
          <div className="inline-block px-8 py-3 bg-[var(--accent-yellow)] text-[#1a3328] rounded-full font-['Patrick_Hand'] text-xl sm:text-2xl font-bold mb-8">
            O QUE NINGUÉM TEM
          </div>
          ...
          {diferenciais.map((item, index) => (
            ...
            >
              ...
              <div className="relative z-10">
                {/* Badge */}
                <div className="absolute top-0 right-0 bg-[var(--accent-yellow)] text-[#1a3328] px-4 py-2 rounded-bl-lg font-['Poppins'] text-sm font-bold">
                  {item.badge}
                </div>
        ...
        >
          <div className="inline-block px-10 py-6 bg-[rgba(255,255,255,0.08)] rounded-2xl border border-[rgba(255,255,255,0.2)]">
            <p className="text-2xl sm:text-3xl font-['Caveat'] text-[var(--chalk-white)] mb-3">

...
fs.mkdirSync('D:/enem-ia/enem-pro/app/assinatura/sucesso', { recursive: true });
fs.writeFileSync('D:/enem-ia/enem-pro/app/assinatura/sucesso/page.tsx', content);
console.log('Created sucesso page');

    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0d2818] to-[#1b3d29] text-white font-['Poppins'] relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-8 py-12">
        ...
        >
          ...
          <p className="text-lg text-white/90 leading-relaxed">Os tempos verbais no presente em inglês expressam ações que acontecem no momento da fala, rotinas ou verdades universais. Dominar esses tempos é essencial para a comunicação básica.</p>
        </motion.div>
        ...
        >
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <p className="text-white/80">Usado para rotinas, hábitos, verdades universais e fatos. Forma: sujeito + verbo (s na 3ª pessoa). Exemplo: "She works every day."</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-white/80">Ações acontecendo agora ou planos futuros. Forma: am/is/are + verb-ing. Exemplo: "I am studying English."</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-white/80">Ações que começaram no passado e continuam no presente ou acabaram de acontecer. Forma: have/has + past participle. Exemplo: "I have lived here for 5 years."</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-white/80">Ações que começaram no passado e ainda estão acontecendo. Forma: have/has been + verb-ing. Exemplo: "I have been studying for 3 hours."</p>
            </motion.div>
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <div>
                ...
                <p className="text-white/70 mt-1">"I work" = rotina/hábito. "I am working" = ação acontecendo agora.</p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div>
                <strong className="text-white/90">Solução:</strong>
                <p className="text-white/70 mt-1">"Since" indica ponto no tempo (since 2020). "For" indica duração (for 3 years).</p>
              </div>
            </motion.div>
        ...
        >
          ...
          <div className="grid gap-4">
            ...
            >
              <span className="text-2xl">✓</span>
              <p className="text-white/90">Present Continuous para ações NOW</p>
            </motion.div>
            ...
            >
              <span className="text-2xl">✓</span>
              <p className="text-white/90">Verbos de estado (know, like, want) geralmente não usam continuous</p>
            </motion.div>
        ...
        >
          ...
          <div className="grid gap-4">
            ...
            >
              <span className="text-2xl">✗</span>
              <p className="text-white/90">Usar continuous com verbos de estado: "I am knowing" ❌</p>
            </motion.div>
            ...
            >
              <span className="text-2xl">✗</span>
              <p className="text-white/90">Esquecer o "s" na 3ª pessoa do simple: "She work" ❌</p>
            </motion.div>

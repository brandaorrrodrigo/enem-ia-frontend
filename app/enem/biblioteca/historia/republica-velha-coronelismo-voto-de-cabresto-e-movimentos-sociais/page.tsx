...
export default function RepublicaVelhaCoronelismoVotoDeCabrestoEMovimentosSociaisPage() {
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-12">
          <h1 className="text-4xl sm:text-5xl font-bold mb-4 bg-gradient-to-r from-white to-white/80 bg-clip-text text-transparent">
            República Velha: coronelismo, voto de cabresto e movimentos sociais
          </h1>
        ...
        {showQuiz && (
          <section className="mb-12">
            <MicroQuiz
              moduloSlug="historia_republica-velha-coronelismo-voto-de-cabresto-e-movimentos-sociais"
              questoes={questoes}
            />
          </section>
        )}

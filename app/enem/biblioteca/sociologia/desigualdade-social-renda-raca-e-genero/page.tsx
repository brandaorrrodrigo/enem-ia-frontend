...
export default function DesigualdadeSocialRendaRacaEGeneroPage() {
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-12">
          <h1 className="text-4xl sm:text-5xl font-bold mb-4 bg-gradient-to-r from-white to-white/80 bg-clip-text text-transparent">
            Desigualdade social: renda, raça e gênero
          </h1>
        ...
        {showQuiz && (
          <section className="mb-12">
            <MicroQuiz
              moduloSlug="sociologia_desigualdade-social-renda-raca-e-genero"
              questoes={questoes}
            />
          </section>
        )}

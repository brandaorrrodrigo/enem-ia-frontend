    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0d2818] to-[#1b3d29] text-white font-['Poppins'] relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-8 py-12">
        ...
        >
          ...
          <p className="text-lg text-white/90 leading-relaxed">Pronomes substituem ou acompanham substantivos. Há vários tipos: pessoais (yo, tú), possessivos (mi, tu), reflexivos (me, te), demonstrativos (este, ese).</p>
        </motion.div>
        ...
        >
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <p className="text-white/80">Sujeito: yo, tú, él/ella, nosotros, vosotros, ellos. Objeto: me, te, lo/la, nos, os, los/las.</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-white/80">Antes do substantivo: mi, tu, su, nuestro, vuestro, su. Após: mío, tuyo, suyo. Ex: "Mi casa" ou "La casa es mía".</p>
            </motion.div>
        ...
        >
          ...
          <div className="grid gap-4">
            ...
            >
              ...
              <p className="text-white/90">Pronomes pessoais podem ser omitidos (conjugação indica pessoa)</p>
            </motion.div>
            ...
            >
              <span className="text-2xl">✓</span>
              <p className="text-white/90">Possessivos concordam em número: mi/mis, tu/tus</p>
            </motion.div>
            ...
            >
              <span className="text-2xl">✓</span>
              <p className="text-white/90">Reflexivos vêm antes do verbo conjugado</p>
            </motion.div>
            ...
            >
              <span className="text-2xl">✓</span>
              <p className="text-white/90">"Se" é 3ª pessoa singular E plural</p>
            </motion.div>
        ...
        >
          ...
          <div className="grid gap-4">
            ...
            >
              <span className="text-2xl">✗</span>
              <p className="text-white/90">Esquecer reflexivo: "Yo levanto" ❌ (correto: Me levanto)</p>
            </motion.div>

...
export const MATERIAS: Materia[] = [
  ...
  },
  {
    ...
    modulos: [
      ...
      {
        title: 'Vocabulary - False Friends',
        slug: 'false-friends',
        descricao: 'Falsos cognatos mais comuns',
        icon: '⚠️',
      },
      {
        title: 'Vocabulary - Connectives',
        slug: 'connectives',
  ...
  },
  {
    id: 'espanhol',
    nome: 'Espanhol',
    nomeCompleto: 'Linguagens e Códigos - Espanhol',
    icon: '🇪🇸',
    color: '#dc2626',
    modulos: [
      {
        title: 'Tiempos Verbales - Presente',
        slug: 'tiempos-presente',
        descricao: 'Presente de indicativo y subjuntivo',
        icon: '⏰',
      },
      {
        title: 'Tiempos Verbales - Pasado',
        slug: 'tiempos-pasado',
        descricao: 'Pretérito perfecto, indefinido e imperfecto',
        icon: '📅',
      },
      {
        title: 'Tiempos Verbales - Futuro',
        slug: 'tiempos-futuro',
      ...
      {
        title: 'Vocabulario - Heterosemánticos',
        slug: 'heterosemanticos',
        descricao: 'Palavras com significados diferentes',
        icon: '⚠️',
      },
      {
        title: 'Vocabulario - Conectores',
        slug: 'conectores',

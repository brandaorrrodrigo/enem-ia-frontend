...
export default function ElementosDasArtesVisuaisPage() {
    ...
    <div className="min-h-screen bg-gradient-to-br from-fuchsia-900 to-fuchsia-700 text-white">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="mb-12">
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
            <div className="flex items-center gap-3 mb-6">
              <div className="p-2 bg-#d946ef/20 rounded-lg">
                <BookOpen className="w-6 h-6 text-#d946ef" style={{ color: '#d946ef' }} />
              </div>
        ...
        {showQuiz && (
          <section className="mb-12">
            <MicroQuiz
              moduloSlug="artes_elementos-das-artes-visuais"
              questoes={questoes}
            />
          </section>
        )}

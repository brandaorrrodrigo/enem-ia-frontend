  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (percent > progresso) {
        ...
        localStorage.setItem('biblioteca_ingles_modal-verbs', Math.floor(percent).toString());
      }
    };

    const savedProgress = localStorage.getItem('biblioteca_ingles_modal-verbs');
    if (savedProgress) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0d2818] to-[#1b3d29] text-white font-['Poppins'] relative overflow-hidden">
      ...
      >
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-5xl font-bold font-['Patrick_Hand']">Modal Verbs</h1>
              <p className="text-xl text-white/80 mt-2">Can, must, should, may, might</p>
            </div>
          </div>
      ...
      <div className="max-w-4xl mx-auto px-8 py-12">
        ...
        >
          ...
          <p className="text-lg text-white/90 leading-relaxed">Modal verbs são verbos auxiliares que expressam habilidade, permissão, obrigação, possibilidade e conselho. Não têm -s na 3ª pessoa e são seguidos de verbo no infinitivo sem "to".</p>
        </motion.div>
        ...
        >
          ...
          <div className="space-y-4">
            ...
            >
              <h3 className="text-xl font-bold mb-2">Can / Could</h3>
              <p className="text-white/80">Habilidade, possibilidade, permissão. "Can" = presente. "Could" = passado/mais educado. Ex: "I can swim."</p>
            </motion.div>
            ...
            <motion.div
              ...
              transition={{ duration: 0.5, delay: 0.1 }}
            >
              <h3 className="text-xl font-bold mb-2">Must / Have to</h3>
              <p className="text-white/80">Obrigação. "Must" = forte, pessoal. "Have to" = obrigação externa. Ex: "You must study."</p>
            </motion.div>
            ...
            >
              <h3 className="text-xl font-bold mb-2">Should / Ought to</h3>
              <p className="text-white/80">Conselho, recomendação. Ex: "You should see a doctor."</p>
            </motion.div>
            ...
            >
              <h3 className="text-xl font-bold mb-2">May / Might</h3>
              <p className="text-white/80">Possibilidade, permissão formal. "May" = mais provável. "Might" = menos provável. Ex: "It may rain."</p>
            </motion.div>
        ...
        >
          ...
          <div className="space-y-6">
            ...
            <motion.div
              ...
              transition={{ duration: 0.5, delay: 0 }}
            >
              <h3 className="text-xl font-bold mb-3">Habilidade</h3>
              <div className="mb-3">
                <strong className="text-white/90">Problema:</strong>
                <p className="text-white/70 mt-1">I ___ speak three languages.</p>
              </div>
              <div>
                <strong className="text-white/90">Solução:</strong>
                <p className="text-white/70 mt-1">I can speak three languages. (habilidade atual)</p>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              transition={{ duration: 0.5, delay: 0.1 }}
            >
              <h3 className="text-xl font-bold mb-3">Obrigação</h3>
              <div className="mb-3">
                <strong className="text-white/90">Problema:</strong>
                <p className="text-white/70 mt-1">You ___ wear a seatbelt. (lei)</p>
              </div>
              <div>
                <strong className="text-white/90">Solução:</strong>
                <p className="text-white/70 mt-1">You must wear / have to wear a seatbelt.</p>
              </div>
            </motion.div>
        ...
        >
          ...
          <div className="grid gap-4">
            ...
            >
              ...
              <p className="text-white/90">Can = habilidade/permissão informal</p>
            </motion.div>
            ...
            >
              <span className="text-2xl">✓</span>
              <p className="text-white/90">Could = passado de can OU pedido educado</p>
            </motion.div>
            ...
            >
              <span className="text-2xl">✓</span>
              <p className="text-white/90">Must = obrigação forte / mustn't = proibição</p>
            </motion.div>
            ...
            >
              <span className="text-2xl">✓</span>
              <p className="text-white/90">Should = conselho (você deveria)</p>
            </motion.div>
        ...
        >
          ...
          <div className="grid gap-4">
            ...
            >
              <span className="text-2xl">✗</span>
              <p className="text-white/90">"He cans swim" ❌ (correto: He can swim)</p>
            </motion.div>
            ...
            >
              <span className="text-2xl">✗</span>
              <p className="text-white/90">"I must to go" ❌ (correto: I must go)</p>
            </motion.div>
            ...
            >
              <span className="text-2xl">✗</span>
              <p className="text-white/90">Confundir mustn't (proibido) com don't have to (não precisa)</p>
            </motion.div>

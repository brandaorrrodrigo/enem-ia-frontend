...
// Script para atualizar a página de perfil com seção de plano/assinatura

const perfilPage = `'use client';
...
fs.writeFileSync('D:/enem-ia/enem-pro/app/enem/perfil/page.tsx', perfilPage);
console.log('Pagina de perfil atualizada com secao de plano/assinatura!');

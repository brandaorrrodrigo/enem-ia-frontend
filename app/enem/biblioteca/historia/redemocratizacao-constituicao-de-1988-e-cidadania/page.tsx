...
export default function RedemocratizacaoConstituicaoDe1988ECidadaniaPage() {
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-12">
          <h1 className="text-4xl sm:text-5xl font-bold mb-4 bg-gradient-to-r from-white to-white/80 bg-clip-text text-transparent">
            Redemocratização, Constituição de 1988 e cidadania
          </h1>
        ...
        {showQuiz && (
          <section className="mb-12">
            <MicroQuiz
              moduloSlug="historia_redemocratizacao-constituicao-de-1988-e-cidadania"
              questoes={questoes}
            />
          </section>
        )}

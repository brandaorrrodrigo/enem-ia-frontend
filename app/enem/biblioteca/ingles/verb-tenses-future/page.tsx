    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0d2818] to-[#1b3d29] text-white font-['Poppins'] relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-8 py-12">
        ...
        >
          ...
          <p className="text-lg text-white/90 leading-relaxed">Há várias formas de expressar futuro em inglês, cada uma com nuances específicas. Will para decisões espontâneas, going to para planos e present continuous para agendamentos.</p>
        </motion.div>
        ...
        >
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <p className="text-white/80">Previsões, promessas, decisões espontâneas. Forma: will + verbo. Exemplo: "I will help you."</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-white/80">Intenções, planos, evidências. Forma: am/is/are going to + verbo. Exemplo: "I am going to travel next month."</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-white/80">Horários fixos e programações. Exemplo: "The train leaves at 8pm."</p>
            </motion.div>
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <div>
                ...
                <p className="text-white/70 mt-1">"Will" = decisão agora. "Going to" = já planejou antes.</p>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              transition={{ duration: 0.5, delay: 0.1 }}
            >
              <h3 className="text-xl font-bold mb-3">Future com evidência</h3>
              <div className="mb-3">
                <strong className="text-white/90">Problema:</strong>
              ...
              <div>
                <strong className="text-white/90">Solução:</strong>
                <p className="text-white/70 mt-1">It is going to rain. (evidência visual)</p>
              </div>
            </motion.div>
        ...
        >
          ...
          <div className="grid gap-4">
            ...
            >
              ...
              <p className="text-white/90">Will = decisão instantânea, previsão</p>
            </motion.div>
            ...
            >
              <span className="text-2xl">✓</span>
              <p className="text-white/90">Going to = plano prévio, evidência</p>
            </motion.div>
        ...
        >
          ...
          <div className="grid gap-4">
            ...
            >
              <span className="text-2xl">✗</span>
              <p className="text-white/90">Usar "will" para planos já feitos</p>
            </motion.div>
            ...
            >
              <span className="text-2xl">✗</span>
              <p className="text-white/90">"I will to go" ❌ (correto: I will go)</p>
            </motion.div>
